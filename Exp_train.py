...
def main_nologduringtrain():
    ...
    model_file_name = 'exp_nologintrain.pt'#consistency_testOutside_nolog.pt'
    model_and_result_folder = './exp_nologintrain'
