...
from Exp_modelandloss_temp import *
...
def main():
    ...
    model_save_path = 'expwithsign_model_tanh_nofinetune_newsignmodel_realtest_temp.pt'
    results_figure_folder = './expwithsign_results_tanh_nofinetune_newsignmodel_realtest_temp'
